              ...
              <div className="w-layout-grid grid-5">
                ...
                <div id="w-node-_23404ea0-b511-250b-a175-e47ddd89ac64-2f66f50a" className="w-layout-vflex resume-body">
                  <div className="body-1 grey light">
                    {"Incoming Fall 2025; will work on AI-focused design initiatives for Solace’s real-time event streaming and integration platform"}
                  </div>
                </div>
                ...
                <div id="w-node-_63d7e5a9-ad62-bd3e-3cbb-2e5eb40fc81f-2f66f50a" className="w-layout-vflex resume-body">
                  <div className="body-1 grey light">
                    {"Led the UX design for 2 healthcare devices by mapping workflows, iterating 5x, creating prototypes, and conducting user testing sessions, resulting in "}
                ...
                <div id="w-node-_2ec89ac6-b873-7265-1815-a1cff5695613-2f66f50a" className="w-layout-vflex resume-body">
                  <div className="body-1 grey light">
                    {"Designed an AI chatbot interface for accessibility information, improving employee access to WCAG guidelines and internal accessibility solutions"}
                  </div>
                  <div className="body-1 grey light">
                    <span className="resume-bold">
                      {"Hosted 4 seminars"}
                    ...
                    {" to identify pain points, leading to organization-wide accessibility improvements"}
                  </div>
                </div>
                <h1 id="w-node-_29d906a6-382e-91bf-df3a-be152638aa59-2f66f50a" className="heading-2">
                  {"Projects"}
                </h1>
                <div id="w-node-f03eab77-9886-eb15-0488-95860d979719-2f66f50a" className="heading-5">
                  {"GradeEasy "}
                  <span className="text-span-7">
                    {"/ Product Designer"}
                  </span>
                </div>
                <div id="w-node-_90af9a4a-8548-e865-9fca-3630082dcf42-2f66f50a" className="w-layout-vflex resume-body">
                  <div className="body-1 grey light">
                    {"Launched a grade tracking app by collaborating with a developer to create workflows, prototypes, new features, and a landing page, "}
                    <span className="resume-bold">
                      {"garnering 34+ beta users"}
                    </span>
                  </div>
                  <div className="body-1 grey light">
                    ...
                    {" on key workflows, resulting in a "}
                    <span className="resume-bold">
                      {"15% improvement in usability scores"}
                    </span>
                  </div>
                </div>
                ...
                <div id="w-node-_1ef02785-07bd-1654-2de4-18fd3801a1bb-2f66f50a" className="w-layout-vflex resume-body">
                  ...
                  <div className="body-1 grey light">
                    {"Developed a design system with standardized UI components, iconography, and grid spacing, improving consistency across digital assets"}
                  </div>
                </div>
                ...
                <div id="w-node-_109fede6-7274-d0dd-89dc-bfb9a78885a8-2f66f50a" className="w-layout-vflex resume-body">
                  <div className="body-1 grey light">
                    {"Coursework in user-centered design, focusing on core design principles, usability testing, interaction design, and creating user personas to inform design strategy"}
                  </div>
                </div>
                ...
                <div id="w-node-ddf7faae-3bef-302f-321c-cc76a677825a-2f66f50a" className="w-layout-vflex resume-body-2">
                  <div className="body-1 grey light">
                    {"UX Research, User Testing, Workflows, Prototyping, Design Systems, Accessibility Guidelines"}
                  </div>
                </div>
                ...
                <div id="w-node-_22b948df-e7e8-0207-fdfc-9de2fd88b128-2f66f50a" className="w-layout-vflex resume-body-2">
                  <div className="body-1 grey light">
                    {"Figma, Miro, Webflow, HTML/CSS, Procreate, Jira, Linear, ClickUp, Aha, Github"}
                  </div>
                </div>
              </div>
            </div>
