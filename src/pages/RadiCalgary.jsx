  ...
  return (
    <>
      ...
      <section className="case-study-body last-container">
        <div className="w-layout-blockcontainer cs-container w-container">
          <div className="w-layout-vflex v-flex _20-spacing">
            ...
            <div className="w-layout-grid cs-overview">
              <div id="w-node-c58bce0d-41fd-974f-2cfe-250cdd393561-644c7706" className="w-layout-vflex v-flex _10-spacing">
              ...
              <div id="w-node-_77de1b24-ad4a-8a70-02a0-2a44c344a94d-644c7706" className="w-layout-vflex v-flex _20-spacing">
              ...
              <div id="w-node-bd1c42d6-8c5c-40b4-3a9c-c6438466ace8-644c7706" className="w-layout-vflex v-flex _20-spacing">
                <div className="w-layout-vflex v-flex _10-spacing">
                  <div className="heading-5">
                    {"Team"}
                  </div>
        ...
        <div className="w-layout-blockcontainer cs-container small w-container">
          <div className="w-layout-vflex v-flex _20-spacing">
            ...
            <div className="body-1">
              ...
              {" The current website is a single page, making all of the information feel very cluttered together."}
            </div>
            <div className="body-1">
              <strong>
                {"Non-unique."}
              </strong>
              {" The current website is not visually unique and looks very generic, we want the redesign to stand out."}
            </div>
            <div className="body-1">
              <strong>
                {"Understand the broader mission."}
              </strong>
              {" Navigating through existing charity websites, it's usually hard to understand their mission."}
            </div>
          </div>
        </div>
        <div className="w-layout-blockcontainer cs-container small w-container">
        ...
        <div className="w-layout-blockcontainer cs-container w-container">
          <div className="w-layout-hflex ia-frame grey shadow">
            <div className="w-layout-vflex flex-block-48">
              <div className="white-chip">
                {"Home Page"}
              </div>
              <div className="darkgrey-chip">
                {"Mission Statement"}
              </div>
              <div className="darkgrey-chip">
                {"Services"}
            ...
            <div className="w-layout-vflex flex-block-48">
              ...
              <div className="transparent-chip">
                {"About"}
              </div>
              <div className="darkgrey-chip">
                {"C-PUCV"}
        ...
        <div className="w-layout-blockcontainer cs-container w-container">
          <div className="w-layout-hflex ia-frame whitesmoke shadow">
            <div className="w-layout-vflex flex-block-48">
              <div className="darkgrey-chip title">
                {"Home Page"}
              </div>
              <div className="white-chip body">
                {"Mission Statement"}
              </div>
              <div className="white-chip body">
                {"Services"}
            ...
            <div className="w-layout-vflex flex-block-48">
              ...
              <div className="transparent-chip black-text">
                {"About"}
              </div>
              <div className="transparent-chip black-text">
                {"Timeline"}
        ...
        <div className="w-layout-blockcontainer cs-container w-container">
          <div className="w-layout-vflex v-flex _20-spacing center-aligned">
            ...
            <a href="https://www.radicalgary.ca/" target="_blank" className="link-block pink w-inline-block" rel="noreferrer">
