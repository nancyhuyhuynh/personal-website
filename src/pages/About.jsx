  ...
  return (
    <>
      <div className="w-layout-blockcontainer container w-container">
            ...
            <div className="w-layout-grid grid-6">
              ...
              <div className="w-layout-vflex flex-block-38">
                <h1 className="title-2">
                  {"About "}
                  <em className="title-2">
                    {"Me"}
                  </em>
                </h1>
                <div className="body-1">
                  {"Hi, I’m "}
                  <span className="body-1 serif">
                    {"Nancy!"}
                  </span>
                  {" I am a Product Designer with a passion for creating seamless digital experiences. I specialize in conducting user research, creating wireframes and prototypes, and collaborating with cross-functional teams to develop intuitive and visually appealing digital experiences. I stay up-to-date on the latest design trends and technologies, continuously expanding my knowledge and skills."}
                </div>
                <div className="body-1">
                  {"Aside from design, I'm a matcha enthusiast and love crocheting! I'm always seeking new challenges to leverage my expertise and passion for learning so feel free to connect with me!"}
                </div>
                <div className="w-layout-hflex flex-block-57">
                  <a href="https://www.linkedin.com/in/nancy-huynh1/" target="_blank" className="link-block-4 w-inline-block" rel="noreferrer">
                    <div className="w-layout-hflex white-button black-border">
                      <div className="body2 pointer">
                        <span className="text-brand-icon black">
                          {""}
                        </span>
                      </div>
                      <div className="body2 pointer">
                  ...
                  <a href="mailto:n4huynh@uwaterloo.ca" target="_blank" className="link-block-4 w-inline-block" rel="noreferrer">
                    <div className="w-layout-hflex white-button black-border">
                      <div className="text-brand-icon fa-solid-900">
                        <span className="text-icon black-icon">
                          {""}
                        </span>
                      </div>
                      <div className="body2 pointer">
              ...
              <div id="w-node-_7c7e63f7-d339-6fb5-00d7-40e87e017c9e-79f132b3" className="w-layout-vflex flex-block-40">
        ...
        <div className="bg-colour-blur head-left invisible">

        </div>
        <div className="bg-colour-blur header-right invisible">
          ...
          <div className="w-layout-vflex flex-block-39">
            <div className="adventures">
              ...
              <div className="w-layout-grid grid-16">
                <div id="w-node-_2c4ba325-c7ff-a645-3152-9116c58842a1-79f132b3" className="w-layout-vflex recent-favs">
                  <div className="recent-fav-image">
                    <img src={withBase('/assets/67f4811e53d58a490af2b3d7_Property-1-Variant2.png')} loading="lazy" alt="" className="bottom-card-image" />
                    <img src={withBase('/assets/67f4811067ea1d7d326c7286_Property-1-Default.png')} loading="lazy" alt="" className="top-card-image" />
                    <img src={withBase('/assets/67f4814803a2a232aea982b9_Frame-152.png')} loading="lazy" alt="" />
                  </div>
                  <div className="body-1 center-aligned">
                    {"Severance"}
                  </div>
                </div>
                <div id="w-node-_3d9cf29b-d170-7370-515b-4322a4cef34f-79f132b3" className="w-layout-vflex recent-favs">
                  <div id="w-node-bb37ba73-f468-0f87-f09a-61ed310f7dfe-79f132b3" className="recent-fav-image">
                    <img src={withBase('/assets/67f484db7dd2a8086d190374_Property-1-Variant2--3-.png')} loading="lazy" alt="" className="bottom-card-image" />
                    <img src={withBase('/assets/67f483db09beda2bb5da76b2_Property-1-Default.png')} loading="lazy" alt="" className="top-card-image" />
                    <img src={withBase('/assets/67f4814803a2a232aea982b9_Frame-152.png')} loading="lazy" alt="" />
                  </div>
                  <div className="body-1 center-aligned">
                    {"Molly Tea"}
                ...
                <div id="w-node-_59972b10-5805-bd27-1a1a-396f701eadc6-79f132b3" className="w-layout-vflex recent-favs">
                  <div className="recent-fav-image">
                    <img src={withBase('/assets/67f484a5a310d880a50f9fc8_Property-1-Variant2--1-.png')} loading="lazy" alt="" className="bottom-card-image" />
                    <img src={withBase('/assets/67f48497a90a02fb206bf8c2_Property-1-Default--1-.png')} loading="lazy" alt="" className="top-card-image" />
                    <img src={withBase('/assets/67f4814803a2a232aea982b9_Frame-152.png')} loading="lazy" alt="" />
                  </div>
                  <div className="body-1 center-aligned">
                    {"Dim Sum"}
